"""
Vercel entrypoint for Learn Chinese — serves all 8 packs via the hub.

    /                       -> Pack chooser (hub landing page)
    /pinyin/                -> Pinyin Fundamentals
    /greetings/             -> Chinese Greetings
...
import learn_chinese as _pkg  # noqa: E402
...
def _make_app():
    ...
    _packs = [load_skill_pack(p, packs_dir=_PACKS_DIR) for p in _CHINESE_PACKS]
